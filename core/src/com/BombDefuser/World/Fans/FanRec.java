...
public class FanRec extends GameObject{
	...
	public FanRec(float x, float y, float width, float height, EDirection direction) {
		...
		switch (direction) {
		case LEFT:
			animation = new Animation(BombMain.assets.get("fans/fan_vertical.png", Texture.class), 0, 5, 0, 16, 40, 4, 4, 2, 2, 0.05f);
			xFliped = true;
			break;
		case RIGHT:
			animation = new Animation(BombMain.assets.get("fans/fan_vertical.png", Texture.class), 0, 5, 0, 16, 40, 4, 4, 2, 2, 0.05f);
			break;
		case UP:
			animation = new Animation(BombMain.assets.get("fans/fan_horisontal.png", Texture.class), 0, 5, 0, 40, 16, 4, 4, 2, 2, 0.05f);
			break;
		case DOWN:
			animation = new Animation(BombMain.assets.get("fans/fan_horisontal.png", Texture.class), 0, 5, 0, 40, 16, 4, 4, 2, 2, 0.05f);
			yFliped = true;
